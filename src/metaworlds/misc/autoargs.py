...
from metaworlds.misc.console import colorize
...
def _get_prefix(cls):
    from metaworlds.policies import Policy
    from metaworlds.baselines import Baseline
    from metaworlds.algos import Algorithm
