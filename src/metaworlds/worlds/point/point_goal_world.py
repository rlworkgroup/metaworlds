...
class PointGoalWorld(GoalConditionedWorld):
    ...
    goal_tolerance = action_space.spaces['velocity'].low
    default_pomdp = {
    ...
    def __init__(self):
        super().__init__(self.observation_space.spaces['point'],
                         self.observation_space.spaces['point'])
    ...
    def step(self, action):
        self._point = self._point + action['velocity']
